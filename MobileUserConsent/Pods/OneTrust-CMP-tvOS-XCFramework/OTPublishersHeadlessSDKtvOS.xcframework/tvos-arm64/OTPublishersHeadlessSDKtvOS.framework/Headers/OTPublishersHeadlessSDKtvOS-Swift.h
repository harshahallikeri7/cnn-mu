...
#ifndef OTPUBLISHERSHEADLESSSDKTVOS_SWIFT_H
#define OTPUBLISHERSHEADLESSSDKTVOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="OTPublishersHeadlessSDKtvOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// Conform to this method to get notified when user selects <code>Accept All</code> option from the Vendor List view and the Vendor List view gets dismissed from the view hierarchy.
- (void)onVendorAcceptAll;
/// Conform to this method to get notified when user selects <code>Reject All</code> option from the Vendor List view and the Vendor List view gets dismissed from the view hierarchy.
- (void)onVendorRejectAll;
/// Conform to this method to get notified when SDK List is shown in the view hierarchy.
- (void)onShowSDKList;
/// Conform to this method to get notified when user selects <code>Back</code> button from the SDK list view and the SDK List view gets dismissed from the view hierarchy.
- (void)onHideSDKList;
/// Conform to this method to get notified when a sdk consent has changed from SDK List View.
- (void)onSDKListSDKConsentChangedWithSdkId:(NSString * _Nonnull)sdkId consentStatus:(int8_t)consentStatus;
...
SWIFT_CLASS("_TtC27OTPublishersHeadlessSDKtvOS18OTGeolocationModel")
...
SWIFT_CLASS("_TtC27OTPublishersHeadlessSDKtvOS19OTProfileSyncParams")
...
SWIFT_CLASS("_TtC27OTPublishersHeadlessSDKtvOS23OTPublishersHeadlessSDK")
...
/// Retrieves the saved consent value for specified category identifier.
/// note:
/// It will return nil in case of application supplied category id doesn’t exist.
...
/// note:
/// It will return nil in case of application supplied SDK id doesn’t exist.
...
SWIFT_CLASS("_TtC27OTPublishersHeadlessSDKtvOS10OTResponse")
...
/// Public class to handle OneTrust SDK’s additional parameters.
SWIFT_CLASS("_TtC27OTPublishersHeadlessSDKtvOS11OTSdkParams")
